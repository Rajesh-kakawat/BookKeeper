...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Test.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Test.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_test())
			{
				...
				Template::redirect(SITE_AREA .'/reports/test');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/test');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Test.Reports.Edit');
		...
		{
			$this->auth->restrict('Test.Reports.Delete');
