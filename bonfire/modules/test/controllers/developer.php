...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Test.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Test.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_test())
			{
				...
				Template::redirect(SITE_AREA .'/developer/test');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/test');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Test.Developer.Edit');
		...
		{
			$this->auth->restrict('Test.Developer.Delete');
